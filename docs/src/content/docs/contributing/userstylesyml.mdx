...
The [`userstyles.yml`](https://github.com/pepsimax271000/userstyles/tree/main/scripts/userstyles.yml) file is responsible for tracking all userstyle and maintainer metadata.

> [!TIP]
> The [`userstyles.schema.json`](https://github.com/pepsimax271000/userstyles/tree/main/scripts/userstyles.schema.json) file is the schema specification for `userstyles.yml`. Please refer to it for clarification.
