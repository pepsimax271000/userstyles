...
The standard library is a collection of mixins to simplify and prevent redundant code in userstyles. The source code is at [`lib/lib.less`](https://github.com/pepsimax271000/userstyles/blob/main/lib/lib.less) and the library is hosted at https://raw.githubusercontent.com/pepsimax271000/userstyles/refs/heads/master/lib/lib.less.
...
```less
@import "https://raw.githubusercontent.com/pepsimax271000/userstyles/refs/heads/master/lib/lib.less";
```
